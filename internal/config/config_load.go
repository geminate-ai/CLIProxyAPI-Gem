...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	if err != nil {
		if optional {
			if os.IsNotExist(err) || errors.Is(err, syscall.EISDIR) {
				...
				cfg := &Config{CredentialInFlight: DefaultCredentialInFlightConfig(), RequestLogStore: DefaultRequestLogConfig()}
	...
	if errValidate := validateCredentialWeightYAML(data); errValidate != nil {
		if optional {
			cfgOptional := &Config{CredentialInFlight: DefaultCredentialInFlightConfig(), RequestLogStore: DefaultRequestLogConfig()}
	...
	cfg.RequestLogStore = DefaultRequestLogConfig()
	...
	if errValidate := cfg.RequestLogStore.Validate(); errValidate != nil {
		return nil, errValidate
	}
