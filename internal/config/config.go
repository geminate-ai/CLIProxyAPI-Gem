...
type Config struct {
	...
	// RequestLogStore controls optional durable, sanitized request event persistence.
	// It is disabled by default and is intentionally independent of application file logging.
	// The distinct request-log-store key preserves the existing request-log boolean.
	RequestLogStore RequestLogConfig `yaml:"request-log-store" json:"request-log-store"`
